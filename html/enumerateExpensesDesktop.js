async function enumerateExpensesDesktop() {
    ...
    expenses_html = '<table id="expenses-table" class="table table-striped table-hover table-responsive"><thead><tr>';
    ...
    document.getElementById('expenses-div').innerHTML = expenses_html;
}
